...
if __name__ == "__main__":
    ...
    for i in range (1000):
        ...
        sim_number = directory.split(os.sep)[2]
        OUTPUT_CC_polytomy_clade = './resamples/' + str(i) + '/clade_analyses_CC/' + sim_number + '_one_mutation.txt'
        OUTPUT_linAB_polytomy_clade = './resamples/' + str(i) + '/clade_analyses_AB/' + sim_number + '_two_mutations.txt'
        if not os.path.exists(OUTPUT_subtree):
        ...
        if not os.path.exists(OUTPUT_coal):
